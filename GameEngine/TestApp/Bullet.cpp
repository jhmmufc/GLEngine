...
Bullet::Bullet(glm::vec2 position, glm::vec2 direction, float damage, float speed, GameEngine::Rendering::GLTexture tex) :
    _position(position),
...
void Bullet::draw(GameEngine::Rendering::SpriteBatch& spriteBatch) {
	...
	GameEngine::Rendering::ColourRGBA8 color;
    color.R = 75;
    color.G = 75;
    color.B = 75;
    color.A = 255;
